...
<script>
  ...
  xmlhttp.open("GET","http://localhost/webproK/server/mk-index.php")
  xmlhttp.send()

  xmlhttp.onload = function(){
    const mydta = JSON.parse(this.responseText)
    let tx = '<h3>List Data Matakuliah</h3><table class="table table-hover">'
        tx += '<thead><tr><th scope="col">#</th><th scope="col">Kode MK</th><th scope="col">Matakuliah</th><th scope="col">Nama Dosen</th><th scope="col">SKS</th><th scope="col"><a href="index.php?pg=mk&sp=baru" class="btn btn-primary">Baru</a></th></tr></thead><tbody>'
    let no = 1
