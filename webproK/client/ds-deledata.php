...
<form id="dsDelete">
  <div class="mb-3">
    ...
    <div id="nidnHelp" class="form-text">ubah NIDN dosen.</div>
  </div>

  <div class="mb-3">
    <label for="namadosen" class="form-label">Nama Dosen</label>
    <input type="text" class="form-control" id="txnama">
    <div id="namadosenHelp" class="form-text">ubah Nama dosen.</div>
  </div>
    <span id="sembunyi">
        <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <span id="sembunyi">
        <div class="mb-3">
        <label for="alamat" class="form-label">Mata Kuliah</label>
        <input type="text" class="form-control" id="txalamat">
        <div id="alamatHelp" class="form-text">ubah alamat.</div>
    </div>
    </span>
