...
<form id="mkUpdate">
  <div class="mb-3">
    ...
    <div id="kodeHelp" class="form-text">isikan kode MK.</div>
  </div>
  ...
  <div class="mb-3">
    ...
    <div id="dosenHelp" class="form-text">isikan Jumlah SKS.</div>
  </div>
...
<script>
  ...
  function batal(){
      location.replace("http://localhost/webproK/client/index.php?pg=mk");
  }
</script>